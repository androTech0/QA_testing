    ...
    private fun getImages() {
        ...
        when (Random.nextInt(1, 6)) {
            ...
            1 -> db!!.collection("items").whereEqualTo("group",grou).limit(10).get().addOnSuccessListener { x ->
                ...
                img11.load(x.documents[0].get("image").toString())
                img12.load(x.documents[1].get("image").toString())
                img13.load(x.documents[2].get("image").toString())
                ...
                img17.load(x.documents[6].get("image").toString())
                img18.load(x.documents[7].get("image").toString())
                img19.load(x.documents[8].get("image").toString())
                img20.load(x.documents[9].get("image").toString())
                ...
                img11.setOnClickListener {
                    animView(img11, x.documents[0].get("image").toString())
                }

                img12.setOnClickListener {
                    animView(img12, x.documents[1].get("image").toString())
                }

                img13.setOnClickListener {
                    animView(img13, x.documents[2].get("image").toString())
                }
                ...
                img17.setOnClickListener {
                    animView(img17, x.documents[6].get("image").toString())
                }

                img18.setOnClickListener {
                    animView(img18, x.documents[7].get("image").toString())
                }
            ...
            2 -> db!!.collection("items").whereEqualTo("group",grou).limit(10).get().addOnSuccessListener { x ->
                ...
                img4.load(x.documents[3].get("image").toString())
                img5.load(x.documents[8].get("image").toString())
                img6.load(x.documents[0].get("image").toString())
                img7.load(x.documents[7].get("image").toString())
                img8.load(x.documents[1].get("image").toString())
                img9.load(x.documents[5].get("image").toString())
                img10.load(x.documents[9].get("image").toString())

                img11.load(x.documents[1].get("image").toString())
                img12.load(x.documents[5].get("image").toString())
                img13.load(x.documents[6].get("image").toString())
                img14.load(x.documents[7].get("image").toString())
                img15.load(x.documents[0].get("image").toString())
                img16.load(x.documents[8].get("image").toString())
                img17.load(x.documents[2].get("image").toString())
                img18.load(x.documents[4].get("image").toString())
                img19.load(x.documents[9].get("image").toString())
                img20.load(x.documents[3].get("image").toString())
                ...
                img4.setOnClickListener {
                    animView(img4, x.documents[8].get("image").toString())
                }
                ...
                img6.setOnClickListener {
                    animView(img6, x.documents[7].get("image").toString())
                }
                ...
                img9.setOnClickListener {
                    animView(img9, x.documents[5].get("image").toString())
                }
                ...
                img13.setOnClickListener {
                    animView(img13, x.documents[6].get("image").toString())
                }

                img14.setOnClickListener {
                    animView(img14, x.documents[7].get("image").toString())
                }
                ...
                img16.setOnClickListener {
                    animView(img16, x.documents[8].get("image").toString())
                }

                img17.setOnClickListener {
                    animView(img17, x.documents[2].get("image").toString())
                }

                img18.setOnClickListener {
                    animView(img18, x.documents[4].get("image").toString())
                }
            ...
            3 -> db!!.collection("items").whereEqualTo("group",grou).limit(10).get().addOnSuccessListener { x ->
                ...
                img4.load(x.documents[8].get("image").toString())
                img5.load(x.documents[4].get("image").toString())
                ...
                img13.load(x.documents[2].get("image").toString())
                img14.load(x.documents[0].get("image").toString())
                img15.load(x.documents[1].get("image").toString())
                img16.load(x.documents[5].get("image").toString())
                ...
                img14.setOnClickListener {
                    animView(img14, x.documents[0].get("image").toString())
                }

                img15.setOnClickListener {
                    animView(img15, x.documents[1].get("image").toString())
                }
            ...
            4 -> db!!.collection("items").whereEqualTo("group",grou).limit(10).get().addOnSuccessListener { x ->
                ...
                img3.load(x.documents[2].get("image").toString())
                img4.load(x.documents[6].get("image").toString())
                img5.load(x.documents[9].get("image").toString())
                img6.load(x.documents[7].get("image").toString())
                img7.load(x.documents[3].get("image").toString())
                img8.load(x.documents[1].get("image").toString())
                img9.load(x.documents[5].get("image").toString())
                img10.load(x.documents[8].get("image").toString())

                img11.load(x.documents[3].get("image").toString())
                img12.load(x.documents[9].get("image").toString())
                img13.load(x.documents[2].get("image").toString())
                img14.load(x.documents[6].get("image").toString())
                img15.load(x.documents[5].get("image").toString())
                img16.load(x.documents[8].get("image").toString())
                img17.load(x.documents[7].get("image").toString())
                img18.load(x.documents[1].get("image").toString())
                img19.load(x.documents[0].get("image").toString())
                img20.load(x.documents[4].get("image").toString())
                ...
                img4.setOnClickListener {
                    animView(img4, x.documents[6].get("image").toString())
                }
                ...
                img10.setOnClickListener {
                    animView(img10, x.documents[8].get("image").toString())
                }

                img11.setOnClickListener {
                    animView(img11, x.documents[3].get("image").toString())
                }

                img12.setOnClickListener {
                    animView(img12, x.documents[9].get("image").toString())
                }
                ...
                img17.setOnClickListener {
                    animView(img17, x.documents[7].get("image").toString())
                }

                img18.setOnClickListener {
                    animView(img18, x.documents[1].get("image").toString())
                }

                img19.setOnClickListener {
                    animView(img19, x.documents[0].get("image").toString())
                }

                img20.setOnClickListener {
                    animView(img20, x.documents[4].get("image").toString())
                }
            }
            ...
            5 -> db!!.collection("items").whereEqualTo("group",grou).limit(10).get().addOnSuccessListener { x ->
                ...
                img4.load(x.documents[6].get("image").toString())
                img5.load(x.documents[8].get("image").toString())
                img6.load(x.documents[9].get("image").toString())
                img7.load(x.documents[7].get("image").toString())
                img8.load(x.documents[5].get("image").toString())
                img9.load(x.documents[3].get("image").toString())
                img10.load(x.documents[1].get("image").toString())

                img11.load(x.documents[9].get("image").toString())
                img12.load(x.documents[7].get("image").toString())
                ...
                img5.setOnClickListener {
                    animView(img5, x.documents[8].get("image").toString())
                }

                img6.setOnClickListener {
                    animView(img6, x.documents[9].get("image").toString())
                }

                img7.setOnClickListener {
                    animView(img7, x.documents[7].get("image").toString())
                }
                ...
                img11.setOnClickListener {
                    animView(img11, x.documents[9].get("image").toString())
                }

                img12.setOnClickListener {
                    animView(img12, x.documents[7].get("image").toString())
                }
                ...
                img19.setOnClickListener {
                    animView(img19, x.documents[2].get("image").toString())
                }
